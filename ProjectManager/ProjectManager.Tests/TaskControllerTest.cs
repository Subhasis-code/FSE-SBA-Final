...
namespace ProjectManager.Test
{
    ...
    public class TaskControllerTest
    {
        ...
        public void TestRetrieveTasks_Success()
        {
            ...
            var result = controller.RetrieveTaskByProjectId(projectid) as JSONResponseModel;
        ...
        public void TestRetrieveParentTasks_Success()
        {
            ...
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.RetrieveParentTasks() as JSONResponseModel;
        ...
        public void TestInsertTasks_Success()
        {
            ...
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.InsertTaskDetails(task) as JSONResponseModel;
        ...
        public void TestUpdateProjects_Success()
        {
            ...
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.UpdateTaskDetails(testTask) as JSONResponseModel;
        ...
        public void TestDeleteProjects_Success()
        {
            ...
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.DeleteTaskDetails(testTask) as JSONResponseModel;
        ...
        public void TestRetrieveTaskByProjectId_Success()
        {
            ...
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.RetrieveTaskByProjectId(12345) as JSONResponseModel;
        ...
        public void TestInsertTask_NullTaskObject()
        {
            ...
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.InsertTaskDetails(null) as JSONResponseModel;
        }
        ...
        public void TestUpdateTask_NullTaskObject()
        {
            ...
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.UpdateTaskDetails(null) as JSONResponseModel;
        }
        ...
        public void TestUpdateTask_NegativeTaskParentId()
        {
            ...
            task.Parent_ID = -234;
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.UpdateTaskDetails(task) as JSONResponseModel;
        }
        ...
        public void TestDeleteTask_NullTaskObject()
        {
            ...
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.DeleteTaskDetails(null) as JSONResponseModel;
        }
        ...
        public void TestDeleteTask_NegativeTaskParentId()
        {
            ...
            task.Parent_ID = -234;
            var controller = new TaskController(new BC.TaskBC(context));
            var result = controller.DeleteTaskDetails(task) as JSONResponseModel;
        }
