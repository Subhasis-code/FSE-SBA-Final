...
namespace ProjectManager.Controllers
{
    ...
    public class UserController : ApiController
    {
        ...
        [ProjectManagerExceptionFilter]
        [Route("api/user/add")]
        public JSONResponseModel InsertUserDetails(User user)
        {
            if (user == null)
            {
        ...
        [ProjectManagerLogFilter]
        [ProjectManagerExceptionFilter]
        public JSONResponseModel UpdateUserDetails(User user)
        {
            if (user == null)
            {
                throw new ArgumentNullException("User id is null");
        ...
        public JSONResponseModel DeleteUserDetails(User user)
        {
            if (user == null)
            {
                throw new ArgumentNullException("User id is null");
